...
<table>
    <tr>
        ...
        <td>
            ...
            <asp:DropDownList ID="ddlCustomerType" runat="server"></asp:DropDownList></td>
    </tr>
    <tr>
        <td>Birthday</td>
    ...
    <tr>
        ...
        <td></td>
        <td><asp:TextBox ID="txtCode" runat="server" Visible="false"></asp:TextBox><asp:TextBox ID="txtTotal" runat="server" Visible="false"></asp:TextBox></td>
    </tr>
</table>
